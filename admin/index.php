<?php
    ...
    if ($_POST['hidden'] == 'submitted'){
        ...
        $write .= "\n";
        $write .= '$bodyBackgroundColor = "'. $_POST['bodyBackgroundColor'].'";';  
        $write .= "\n";
        ...
        $write .= "\n";
        $write .= '$showMenuColor = "'. $_POST['showMenuColor'].'";';
        $write .= "\n";
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div id="jumbotron">
                <table>
                    ...
                    <tr>
                        <td><label>website Backgound color</label></td>
                        <td><input type="text" name="bodyBackgroundColor" value="<?php echo $bodyBackgroundColor;?>" ></td>
                        <td style="font-size:12px;">background color will not show if background image is used</td>
                    </tr>
                    <tr>
            ...
            <div id="jumbotron">
                <table>
                    ...
                    <tr>
                        <td><label>Collapsed Menu Color</label></td>
                        <td><input type="text" name="showMenuColor" class="color {adjust:false}" value="<?php echo $showMenuColor;?>" ></td>
                        <td style="font-size:13px;"> Add # At the beginning of number value eg:- #6B61FF or Use basic color names!</td>
                    </tr>
                </table>
            </div>
